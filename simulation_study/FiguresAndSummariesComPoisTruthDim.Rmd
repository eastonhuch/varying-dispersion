...
```{r simdat, echo=F}
simnames <-c(
  'SimComPoisTruthDim20251223100.Rdata',
  'SimComPoisTruthDim20251223250.Rdata',
  'SimComPoisTruthDim20251223500.Rdata',
  'SimComPoisTruthDim202512231000.Rdata')
...
for(ii in 1:length(simnames)){
  ...
  png(paste0("Figs/MuComPoisTruthCoverageDimn",myn[ii],".png"), width=7.5,height=5.1,units="in", res=300)
  ...
  png(paste0("Figs/SigmaComPoisTruthCoverageDimn",myn[ii],".png"), width=7.5,height=5.1,units="in", res=300)
