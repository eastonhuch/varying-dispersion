...
# May 8, 2025
# In this version, I'm adding quasi-poisson fits
################################
...
for(n in myns){
  ...
  mu <- exp(log_mu)
  alpha_true <- c(0.1, 0, -0.2, 0.05) # Not directly comparable across all models; these values of alpha (alpha0=1; combined with the values of beta) result in underdispersion; to create overdispersed data, use alpha0=-1 or alpha0=-0.5
  ...
  save.image(file=paste0("SimComPoisTruth20250508",n,".Rdata"))
}