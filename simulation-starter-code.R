...
mu_marginal_coverage <- colMeans(mu_rep_coverage)
mu_marginal_coverage_ses <- apply(mu_rep_coverage, 2, sd) / sqrt(reps)
...
sd_marginal_coverage <- colMeans(sd_rep_coverage)
sd_marginal_coverage_ses <- apply(sd_rep_coverage, 2, sd) / sqrt(reps)
